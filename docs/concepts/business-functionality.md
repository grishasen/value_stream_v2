...
From the same counts, reports can show the share of impressions in repeat
buckets and the historical share of impressions and positive outcomes above a
proposed frequency cap. These shares describe observed activity; they do not
predict how customers would behave under a new cap.
