...
revision 9. It uses one bounded database at the stable path
...
before 9 are obsolete acceleration artifacts and are rebuilt, not migrated,
into schema-revision-9 state. See
