...
revision 9—the default and only supported revision—and one stable database path
...
| `frequency_response` | Engagement rate by bounded number of impressions of the same action |
